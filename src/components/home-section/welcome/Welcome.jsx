        ...
        >
            <div className="welcome__info relative">
                <div className="welcome__info__content">
                    <div className="title">
                        <span><br/>Bienvenidos a la Landing Page de</span>
                        <h2 className="main-color">Dario Delgado</h2>
                    </div>
                    <div className="description m-t-4">
                        Soy un ingeniero mecatronico con gustos en los desarrollos tecnologia e
                        innovador, con experiencia basica en desarrollo web, ademas de
